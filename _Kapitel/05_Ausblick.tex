\chapter{Entwurf eines Fuzzy-Reglers}

\section{Grundlegende Idee und Begründung}
...
\begin{figure}[H]
    \centering
    % TODO: Bild einsetzen
     \includegraphics[width=0.85\textwidth]{_Bilder/BSP_Bild.png}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{lX}
        \toprule
        \textbf{Kostenanteil} & \textbf{Bedeutung} \\
        \midrule
        Positionskosten &
        ...
        Zeitkosten &
        Bevorzugen kürzere Fahrzeiten beziehungsweise weniger Simulationsschritte. \\

        Stellgrößenkosten &
        Bestrafen hohe translatorische und rotatorische Stellgrößen. \\

        Glattheitskosten &
        Bestrafen Sprünge in $v_x$, $v_y$ und $\omega$ und reduzieren damit Oszillationen. \\

        Penalty &
        Hohe Zusatzkosten, wenn das Ziel innerhalb der Toleranzen nicht erreicht wird. \\
        \bottomrule
    \end{tabularx}
\end{table}
...
Die Ergebnisse wurden per Konsolenausgabe dokumentiert und umfassen die Kosten, Endwerte und optimierten Parameter. Für die Startparameter ergibt sich eine Gesamtkostenbewertung von etwa $4{,}078445$. Nach der Optimierung sinken die Kosten auf etwa $2{,}711807$. 
