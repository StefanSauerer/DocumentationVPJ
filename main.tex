...
\newcommand{\Titel}{Bahnregelung für einen omnidirektionalen Roboter}
\newcommand{\Fak}{Automatisierungstechnik}
\newcommand{\Datum}{\today}
\newcommand{\Name}{Stefan Sauerer, Bent Röttger, Lukas Ghassemimolahajlou}
% --------------------------------------------------------------------------------------- %
...
% Hauptteil
\include{_Kapitel/01_Einleitung}
\include{_Kapitel/02_Konzept}
\include{_Kapitel/03_Beobachter}
\include{_Kapitel/04_Regler}
\include{_Kapitel/05_Ausblick}
\include{_Kapitel/06_Fazit}
